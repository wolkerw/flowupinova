          ...
          >
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="flex flex-col sm:flex-row items-center gap-6 justify-center">
                <Button size="lg" asChild className="text-white bg-primary px-12 rounded-full h-16 text-lg shadow-lg hover:shadow-xl hover:scale-105 transition-all">
                  <Link href="/acesso/cadastro">Começar Grátis Agora</Link>
                </Button>
                <Button variant="outline" size="lg" className="rounded-full h-16 px-10 border-primary/20 hover:bg-primary/5 text-lg" onClick={() => openContactModal()}>
