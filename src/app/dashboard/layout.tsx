  ...
  return (
    <div className="flex min-h-screen w-full bg-muted/50">
      ...
      {(() => {
        ...
        const clientInfo = userName ? `${userName} (${userEmail})` : userEmail || "Cliente";
        const planTag = userPlan ? ` [Plano: ${userPlan.toUpperCase()}]` : "";
        const textMsg = `Olá Suporte NumVapt! Sou cliente logado no app: ${clientInfo}${planTag}. Preciso de ajuda com a minha conta.`;
        const waLink = `https://wa.me/5551920044035?text=${encodeURIComponent(textMsg)}`;
        ...
        return (
          <a
            ...
            aria-label="Entre em contato pelo WhatsApp com o suporte"
          >
            <Button
              size="icon"
