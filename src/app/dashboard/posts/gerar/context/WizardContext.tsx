  ...
  const handleGeneratePrompts = async (contentOverride?: GeneratedContent) => {
    ...
    try {
      ...
      if (referenceImageFile) {
        ...
        if (resData.correctedHeadline && !productHeadline.trim()) {
      ...
      if (referenceImageFile) {
        ...
        if (useImagen4Ref) {
          ...
          toast({
            ...
            description: "Sua nova imagem publicitária está pronta e ficou incrível.",
          });
          return;
        }
        ...
        if (useNanoBananaRef) {
          ...
          try {
            ...
            console.log(
              `[WIZARD] ✅ Geração concluída com sucesso: ${finalUrl}`
            );
            setGeneratedImages([finalUrl]);
            setSelectedImage(finalUrl);
            setFluxImageUrl(finalUrl);
