    ...
    >
      <Card className="border-none shadow-lg">
        ...
        <CardContent>
          ...
          {selectedContentId && generatedContent.length > 0 && !isSyncImageMode && mode !== "concept" && mode !== "reference-link" && (
        ...
        <CardFooter className="flex items-end justify-between">
          ...
          <Button
            ...
            disabled={
              !selectedContentId ||
              (!isSyncImageMode && mode !== "concept" && mode !== "reference-link" && insertTextOnImage === null) ||
