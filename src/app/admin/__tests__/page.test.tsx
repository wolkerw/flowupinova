...
import AdminDashboardPage, { CustomPieTooltip } from "../page";
...
describe("AdminDashboardPage", () => {
  ...
  it("renders CustomPieTooltip correctly when active", () => {
    const payload = [
      {
        payload: {
          model: "imagen-3.0-generate-002",
    ...
    render(<CustomPieTooltip active={true} payload={payload} />);
    expect(screen.getByText("imagen-3.0-generate-002")).toBeInTheDocument();
  });
});
