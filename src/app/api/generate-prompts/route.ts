...
`;
    ...
    const LAYOUT_TECHNICAL: Record<string, string> = {
      ...
      GLASSMORPHISM: "LAYOUT STYLE — GLASSMORPHISM: A large, semi-transparent frosted glass UI card (glassmorphism graphic element) floats prominently in the foreground of the composition. The literal text MUST be written physically INSIDE this frosted glass panel. The background environment behind the glass card is visible but softly blurred (heavy bokeh effect). This is a mandatory UI graphic overlay. Futuristic, tech, modern.",
