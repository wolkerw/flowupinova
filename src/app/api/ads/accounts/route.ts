...
export async function GET(request: NextRequest) {
    try {
        ...
        // **CORREÇÃO CRÍTICA**: Usar o userAccessToken para listar BMs e contas.
        ...
        if (businesses.length === 0) {
            ...
            for (const business of businesses) {
                ...
                try {
                    // **CORREÇÃO**: Usar o mesmo userAccessToken para listar as contas dentro do BM.
        ...
        // Remove duplicatas e filtra apenas contas ativas (status 1).
