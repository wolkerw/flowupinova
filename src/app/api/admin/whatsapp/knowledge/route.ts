...
export const DEFAULT_KNOWLEDGE_TOPICS: WhatsAppKnowledgeTopic[] = [
  {
    ...
    content: "• Plano Mensal: R$ 490,00/mês (sem fidelidade, cancele quando quiser).\n• Plano Trimestral: R$ 441,00/mês (10% de desconto | total de R$ 1.323,00 a cada 3 meses no cartão recorrente ou Pix).\n• Plano Semestral: R$ 416,50/mês (15% de desconto | total de R$ 2.499,00 a cada 6 meses no cartão recorrente ou Pix).\n• Plano Anual (Cobrança Mensal no Cartão + 1 Mês Grátis): R$ 400,00/mês (13 meses de acesso — 12 meses pagos + 1 mês bônus gratuito!). Cobrança mensal de R$ 400/mês no cartão sem travar nem comprometer o limite total de R$ 4.800 do cliente! Link Oficial: https://www.asaas.com/c/2unkh9p3t6apkcvm",
    isActive: true,
    order: 1,
  ...
  },
  {
    ...
    content: "• Contrato digital formal de 19 cláusulas com aceite consciente.\n• 7 dias de garantia incondicional (direito de arrependimento) com devolução de 100% do valor pago.\n• Pagamento via Cartão de Crédito (na modalidade mensal recorrente de R$ 400/mês sem comprometer o limite total) ou Pix com liberação imediata.",
    isActive: true,
    order: 2,
    updatedAt: new Date().toISOString(),
  },
