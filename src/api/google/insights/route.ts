...
export async function POST(request: NextRequest) {
  try {
    ...
    const readMask =
      "name,title,categories,storefrontAddress,phoneNumbers,websiteUri,metadata,profile";
    ...
    if (!insightsResponse.ok) {
      ...
      throw new Error(
        insightsData.error?.message || "Falha ao buscar dados de performance do Google."
      );
    }
