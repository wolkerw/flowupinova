...
export const config = {
  ...
  instagram: {
    ...
    redirectUri: process.env.NEXT_PUBLIC_INSTAGRAM_REDIRECT_URI || `${aplicationURL}/api/instagram/callback`,
  },
  meta: {
  ...
  google: {
    ...
    redirectUri: process.env.NEXT_PUBLIC_GOOGLE_REDIRECT_URI || `${aplicationURL}/api/google/callback`,
  }
};
